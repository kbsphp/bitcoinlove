...
"Copyright &copy; 2011-YYYY The Bitcoinlove developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitcoinlove", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitcoinlove</b> version", 0));
