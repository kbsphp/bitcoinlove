...
uint256 hashGenesisBlock("0x84b9e95efcb14f340d89721320b4d06fb33b65c0cb3e5f5828e45198ff154a3a");
...
static const int64 nTargetTimespan = 10*30; // Bitcoinlove: 3.5 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x84b9e95efcb14f340d89721320b4d06fb33b65c0cb3e5f5828e45198ff154a3a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x32065614bb345ab433c6add800faa8e8a700ed2bb8823bb2276d1b0c8a8e3332"));
